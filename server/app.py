...
#! General routes
@app.route('/followers')
@app.route('/user/<int:user_id>/following/<int:following_id>')
@app.route('/movies/<int:id>')
@app.route('/movie_collections/<int:id>')
@app.route('/users/<int:id>/movie_collections/<string:name>')
@app.route('/users/<int:id>/movie_collections')
@app.route('/movie_collections')
@app.route('/movies')
@app.route('/shows/<int:id>')
@app.route('/show_collections/<int:id>')
@app.route('/users/<int:id>/show_collections/<string:name>')
@app.route('/users/<int:id>/show_collections')
